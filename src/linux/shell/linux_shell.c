...
internal void
sh_message(bool32 error, String8 title, String8 message)
{
  bool32 done = 0;
  bool32 text_is_long = (str8_find_needle(message, 0, s("\n"), 0) < message.size);
...
internal bool32
sh_install_or_uninstall_self(bool32 write, bool32 install)
{
  bool32 install_state = 0;
  Temp scratch = scratch_begin(0, 0);
