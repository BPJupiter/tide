...
typedef struct R_OGL_Attribute_Array R_OGL_Attribute_Array;
struct R_OGL_Attribute_Array
{
  R_OGL_Attribute *v;
  u64 count;
};
...
typedef struct R_OGL_Format_Info R_OGL_Format_Info;
struct R_OGL_Format_Info
{
...
typedef struct R_OGL_Flush_Buffer R_OGL_Flush_Buffer;
struct R_OGL_Flush_Buffer
{
  R_OGL_Flush_Buffer *next;
  GLuint id;
};

typedef struct R_OGL_Render_Target R_OGL_Render_Target;
struct R_OGL_Render_Target
{
  GLuint fbo;
...
struct R_OGL_Window
{
  ...
  R_OGL_Render_Target stage_target;
  R_OGL_Render_Target stage_scratch_target;
};
...
struct R_OGL_State
{
  ...
  R_OGL_Flush_Buffer *first_buffer_to_flush;
  R_OGL_Flush_Buffer *last_buffer_to_flush;
};
...
internal R_OGL_Format_Info r_ogl_format_info_from_tex2dformat(R_Tex2DFormat fmt);
...
internal Void_Proc *r_ogl_os_load_procedure(char *name);
internal void r_ogl_os_init(Cmd_Line *cmdln);
