...
extern String8_Array txt_keywords_from_lang_kind_table[8];
extern String8_Array txt_multichar_symbols_from_lang_kind_table[8];
extern TXT_Tokeniser_Rule_Array txt_tokenizer_rules_from_lang_kind_table[8];
extern String8 txt_keywords__null[1];
extern String8 txt_multichar_symbols__null[1];
extern TXT_Tokeniser_Rule txt_tokenizer_rules__null[1];
extern String8 txt_keywords__c[32];
extern String8 txt_multichar_symbols__c[20];
extern TXT_Tokeniser_Rule txt_tokenizer_rules__c[7];
