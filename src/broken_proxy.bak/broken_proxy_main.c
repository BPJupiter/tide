...
#define BUILD_TITLE "BROKENPROXY"
...
#define BP_INIT_MANUAL  1

#define ARENA_TABLE_DDEBUG BUILD_DEBUG
...
void entry_point(Cmd_Line *cmdline)
{
    ...
    // re-open stdout handles if cli
#if OS_WINDOWS
    if (cmd_line_has_flag(cmdline, s("cli")))
    {
