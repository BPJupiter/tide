...
struct W32_File_Iter {
    ...
    bool32 is_volume_iter;
    String8_Array drive_strings;
    u64 drive_strings_iter_idx;
};
StaticAssert(sizeof(Member(File_Iter, memory)) >= sizeof(W32_File_Iter), file_iter_memory_size);
