...
typedef struct R_D3D11_Uniforms_Blur_Pass R_D3D11_Uniforms_Blur_Pass;
struct R_D3D11_Uniforms_Blur_Pass
{
  Rng2f32 rect;
...
StaticAssert(sizeof(R_D3D11_Uniforms_Blur_Pass) % 256 == 0, NotAligned); // constant count/offset must be aligned to 256 bytes

typedef struct R_D3D11_Uniforms_Blur R_D3D11_Uniforms_Blur;
struct R_D3D11_Uniforms_Blur
{
  R_D3D11_Uniforms_Blur_Pass passes[Axis2_COUNT];
  Vec4f32 kernel[32];
};
