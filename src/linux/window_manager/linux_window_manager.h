...
typedef struct LNX_WM_Window_Client_Area LNX_WM_Window_Client_Area;
struct LNX_WM_Window_Client_Area
{
    LNX_WM_Window_Client_Area *next;
    Rng2f32 rect;
};
...
struct LNX_WM_Window
{
    ...
    bool32 waiting_for_resize;
    bool32 custom_border;
    f32 custom_title_bar_thickness;
    f32 custom_edge_thickness;
    LNX_WM_Window_Client_Area *first_client_area;
    LNX_WM_Window_Client_Area *last_client_area;
};
...
struct LNX_WM_State
{
    ...
    LNX_WM_Window_Client_Area *free_client_area;
...
internal int lnx_moveresize_code_from_pos(LNX_WM_Window *window, Vec2f32 pos, bool32 *out_is_in_client_area);
internal KeySym lnx_wm_keysym_from_key(WM_Key key);
internal WM_Key lnx_wm_key_from_keysym(KeySym ks, bool32 *out_is_right_sided);
